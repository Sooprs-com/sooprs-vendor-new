...
const Hire_Professional = () => {
 const [visibleDropdowns, setVisibleDropdowns] = useState({});
   ...
   const questions = [
     ...
     {
       id: "4",
       title: "How does Sooprs protect against fraud and scams?",
       answer:
         'Sooprs ensures a secure platform by implementing KYC (Know Your Customer) verification processes, which help prevent fraudulent activities and scams.',
         isBulletPoint: false,
       },
     {
       id: "5",
       title: "What measures are in place to ensure data privacy?",
       answer:
         'Sooprs is committed to data privacy and does not share user data with third parties.',
         isBulletPoint: false,
       },
   ];
...
export default Hire_Professional
